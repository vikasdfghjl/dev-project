...
interface ArticleViewHeaderProps {
  article: Pick<
    Article,
    "title" | "author" | "pubDate" | "feedTitle" | "imageUrl" | "content"
  >;
}

const ArticleViewHeaderComponent: React.FC<ArticleViewHeaderProps> = ({
  article,
}) => {
  return (
    <>
      ...
      <h1 className="text-3xl md:text-4xl font-bold mb-2 text-foreground dark:text-slate-100">
        {article.title}
      </h1>
