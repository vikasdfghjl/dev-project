...
import type { Article, ArticleSortOption, ArticleFilterOption, ArticleViewStyle } from '../types';
import { ArticleListItem } from './ArticleListItem'; // Renamed from ArticleItem
import { ArticleCardItem } from './ArticleCardItem'; // New component
