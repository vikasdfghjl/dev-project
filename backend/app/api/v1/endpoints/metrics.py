...
database_connection_errors = Counter(
    "database_connection_errors_total", "Total number of database connection errors"
)

active_feeds_count = Gauge("active_feeds_count", "Number of active RSS feeds")

articles_scraped_total = Counter(
    "articles_scraped_total", "Total number of articles scraped from feeds"
)
